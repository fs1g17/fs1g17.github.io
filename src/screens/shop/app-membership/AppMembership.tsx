...
const AppMembership = () => {
  return (
    ...
    >
      <Box mt="auto" mb="auto">
        <RedButton href="https://www.trainerize.me/checkout/sematriux/Adam.Mikietinski?planGUID=1431cd0c722b4dee93870d5b356f5c13" sx={{ borderRadius: 0, fontSize: 24, width: 300 }}>
          Buy Now
        </RedButton>
      </Box>
    </ShopSection>
